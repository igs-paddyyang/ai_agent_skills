...
description: "引導建立符合 Model Context Protocol（MCP）規範的 Server，涵蓋 Python SDK 快速上手、Tool/Resource/Prompt 定義、參數驗證與常見模式。當使用者提到 MCP、Model Context Protocol、MCP Server、MCP 開發、建立 MCP、MCP Tool、MCP Resource、mcp-builder、MCP Python SDK、Tool Gateway、MCP 整合、MCP 怎麼用、建立工具伺服器時，請務必使用此技能。"
---
