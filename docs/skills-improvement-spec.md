...
| 4 | 13 個技能停在 v0.1.0 | ⏳ 待處理 | Phase 1 逐步迭代 |
| 5 | 知識指南類觸發頻率不明 | ⏳ 待處理 | Phase 2 評估 |
...
|:---|:---|:---|:---|:---|
| 6.1 | 批次 A 成熟度提升（3 技能） | 60 min | — | ⬜ 待執行 |
| 6.2 | 批次 B 成熟度提升（4 技能） | 60 min | — | ⬜ 待執行 |
| 6.3 | 批次 C 成熟度提升（6 技能） | 45 min | — | ⬜ 待執行 |
| 6.4 | 知識指南合併評估 | 30 min | 6.3 | ⬜ 待執行 |
